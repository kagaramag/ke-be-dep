...
export default async (user = {}) => {
  try {
    let newUser = { };
    user = { ...user, username: `${user.firstName.toLowerCase()}.${user.lastName.toLowerCase()}` };
    ...
    await db.UserRole.create({ roleId: newUserRole.roleId, userId: newUserRole.userId }, { logging: false });
